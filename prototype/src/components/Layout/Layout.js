    ...
    <div className={s.root}>
      <div className={s.wrap}>
        ...
        <main className={s.content}>
          ...
          <Switch>
            <Route path="/template" exact render={() => <Redirect to="/template/vlearn/student"/>} />
            <Route path="/template/vlearn/student" exact component={StudentSlideReader} />
            <Route path="/template/vlearn/teacher" exact component={TeacherRadarDashboard} />
            <Route path="/template/vlearn/eval" exact component={EvalPlayground} />
